    ...
    <div class="custom-container">
        <?php 
            ...
            require_once( plugin_dir_path( __FILE__ ) . 'form/step_1.php');
                ...
                require_once( plugin_dir_path( __FILE__ ) . 'form/step_3');
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="has-drop-shadow">
                                <a href="'.$btnURL.'" class="back_btn '.$btnhide.'"> < </a>
                                '.$btn.'
                                <a href="" class="next_btn '.$btnhide.'" id="next"><img src="'.PluginUrl().'images/spin.gif" class="small_loader"> <span class="next_text">Next</span>  </a>
                            </div>
                        </div>
                    </div>
                </div>
